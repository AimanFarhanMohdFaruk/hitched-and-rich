class RegistriesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to registries_path, status: :see_other, notice: "Registry was successfully destroyed." }
  ...
  private
    ...
    def set_registry
      @registry = Registry.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def registry_params
      params.expect(registry: [ :title, :description, :unique_link, :status, :user_id ])
    end
end
